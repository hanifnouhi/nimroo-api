...
export class AuthController {
  ...
  async googleAuthRedirect(
    ...
    this.logger.debug(
      `Received GET request to /google/callback with user data ${req.user}`,
    );
  ...
  async login(@Request() req, @Res({ passthrough: true }) response: Response) {
    this.logger.debug(
      `Received POST request to /login with user data ${req.user}`,
    );
  ...
  async refreshToken(
    ...
    this.logger.debug(
      `Received POST request to /refresh with user data ${req.user}`,
    );
    return await this.authService.login(req.user, response);
  }
  ...
  async signup(@Body() createUserDto: CreateUserDto) {
    this.logger.debug(
      `Received POST request to /signup with user email ${createUserDto.email}`,
    );
  ...
  async changePassword(
    ...
    this.logger.debug(
      `Received PATCH request to /change-password with id: ${userId}`,
    );
  ...
  async resendVerificationEmail(
    ...
    this.logger.debug(
      `Received POST request to /resend-verification-email with email: ${resendVerificationDto.email}`,
    );
  ...
  async forgotPassword(
    ...
    this.logger.debug(
      `Received POST request to /forgot-password with email: ${forgotPasswordDto.email}`,
    );
  ...
  async unlinkProvider(
    ...
    this.logger.debug(
      `Received POST request to unlink ${provider} for user ${userId}`,
    );
