...
describe('AuthService - Unit', () => {
  ...
  describe('verifyEmail', () => {
    it('should generate a token for verifying user email', async () => {
      await service.verifyEmail(userId, userEmail, UserRole.User, MembershipPlan.FREE, true);
    ...
    it('should return true if the verification email sent successfully', async () => {
      ...
      const result = await service.verifyEmail(userId, userEmail, UserRole.User, MembershipPlan.FREE, true);
  ...
  describe('resendVerificationEmail', () => {
    it('should call verifyEmail and return true if the verification email sent successfully', async () => {
      ...
      expect(verifyEmailSpy).toHaveBeenCalledWith(userId, userEmail, UserRole.User, MembershipPlan.FREE, true);
      expect(result).toBeTruthy();
    });
