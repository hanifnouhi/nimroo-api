...
describe('Stability generate image unit testing', () => {
    ...
    beforeEach(() => {
        ...
        configService = {
            getOrThrow: jest.fn()
                .mockReturnValueOnce('https://api.stability.ai/v1/generation/test-model/text-to-image')
    ...
    it.each([
        ...
        [500, 'internal_error']
    ])('should return appropriate message based on error code when API failed', async (code, message) => {
