...
export class UserDto {
  ...
  @ApiProperty({
    description:
      'User interests that will be use in AI services for more appropriate results',
  ...
  @ApiProperty({
    ...
    example:
      "[{ membership: '123456asdfa456asdf', startedAt: '2025-10-22T00:00:00.000Z', endedAt: '2025-10-22T00:00:00.000Z', wasTrial: false, autoRenewed: false}]",
    default: [],
  })
  @IsArray()
  ...
  @ApiProperty({
    description:
      'User account provider, may be local or google or other social medias',
    example: 'google',
    default: 'local',
  })
  @IsEnum(UserProvider)
